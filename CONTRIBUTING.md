...
- keep GPT-6 Astra focused on high-value reasoning
- route bounded routine work to cheaper capable models
- reduce unnecessary growth of the GPT-6 parent context
...
3. preserves normal Codex behavior outside the GPT-6-specific setup
